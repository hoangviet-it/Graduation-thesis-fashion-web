...
export default function LoadMoreUserNotPay() {
    const state = useContext(GlobalState)
    const [page, setPage] = state.userAPI.pageNotPay
    const [reSultAll] = state.userAPI.resultAll
  ...
  return (
    <div className="load_more"  style={{marginTop:'20px'}}>
